...
class SDKServer {
  ...
  async authenticateRequest(req: Request): Promise<User> {
    ...
    // OAuth authentication is deprecated - using JWT-based auth instead
    throw ForbiddenError("OAuth authentication is no longer supported. Please use JWT-based authentication.");
  }
}
