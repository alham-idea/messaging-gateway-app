...
## واجهة سجلات تسليم SMS — طلب المستخدم
- [ ] تصميم شاشة سجلات SMS في اتجاه عمودي وباستخدام Safe Area
- [ ] عرض ملخص سريع للأعداد حسب الحالة
- [ ] عرض قائمة سجلات SMS فقط دون خلط رسائل WhatsApp
- [ ] إظهار رقم المستلم بصيغة آمنة ونص مختصر ووقت الإرسال والحالة
- [ ] دعم حالات pending وprocessing وsent وfailed بمرئيات واضحة
- [ ] عرض سبب الفشل دون كشف بيانات حساسة غير لازمة
- [ ] إضافة إعادة محاولة للسجلات الفاشلة عبر مسار SMS الحقيقي
- [ ] إضافة حالة فارغة وحالة تحميل وحالة خطأ وإجراء تحديث
- [ ] إضافة مسار تنقل واضح من تبويب الرسائل إلى سجل التسليم
- [ ] إضافة اختبارات حتمية لترشيح SMS وتنسيق الحالات وإعادة المحاولة
- [ ] تشغيل TypeScript والاختبارات والبناء
- [ ] مراجعة الواجهة على الهاتف وحفظ checkpoint

## تصميم واجهة SMS
- [ ] شاشة SMS Delivery Logs مستقلة عن شاشة محادثات WhatsApp
- [ ] شريط علوي بعنوان سجلات SMS وزر تحديث
- [ ] بطاقات ملخص صغيرة: الكل، تم الإرسال، قيد الانتظار، فشل
- [ ] مرشحات أفقية قابلة للتمرير حسب الحالة
- [ ] بطاقات سجلات بترتيب الأحدث أولاً
- [ ] زر إعادة المحاولة يظهر فقط عند الفشل
- [ ] استخدام الألوان الدلالية من theme.config
- [ ] دعم الوضع الداكن والتباين واللمس بيد واحدة
- [ ] عدم استخدام أرقام أو سجلات وهمية في واجهة الإنتاج


## واجهة سجلات SMS — سجل الإنجاز
- [x] إنشاء `design.md` بمواصفات الشاشة والتدفقات والألوان
- [x] إنشاء `app/sms-logs.tsx` كشاشة مستقلة لسجلات SMS
- [x] ربط الشاشة ببيانات SQLite المحلية دون بيانات وهمية
- [x] إضافة إحصاءات الكل والمرسل والانتظار والفشل
- [x] إضافة مرشحات الحالات وقائمة أحدث السجلات
- [x] إخفاء أرقام المستلمين وعرض نص الرسالة ووقت الإنشاء والمحاولات
- [x] إضافة حالات التحميل والخطأ والفراغ والتحديث بالسحب
- [x] إضافة إعادة محاولة للسجلات الفاشلة عبر `messageHandlerService`
- [x] إضافة رابط الشاشة من `app/(tabs)/messages.tsx`
- [x] إضافة اختبارات `sms-log-utils.test.ts`
- [x] نجاح TypeScript والبناء و6 اختبارات واجهة SMS
- [ ] اختبار بصري/وظيفي على جهاز Android فعلي
- [ ] حفظ checkpoint لهذه الواجهة
- [ ] طلب اعتماد المستخدم قبل الخطوة التالية

## واجهة سجلات SMS — نتيجة التحقق
- [x] `pnpm check` ناجح
- [x] `pnpm build` ناجح
- [x] `tests/sms-validation.test.ts` ناجح
- [x] `tests/sms-log-utils.test.ts` ناجح
- [x] 6/6 اختبارات واجهة SMS ناجحة
- [x] لا توجد رسائل حقيقية أثناء الاختبار
- [x] لا توجد تغييرات مدمرة على قاعدة البيانات


## تحسين سجلات SMS — إشعار وبحث متقدم
- [ ] إضافة خدمة إشعارات محلية لقناة SMS فقط
- [ ] إنشاء قناة إشعارات Android مخصصة لفشل SMS
- [ ] طلب صلاحية الإشعارات عند الحاجة دون طلب صلاحيات غير مرتبطة
- [ ] جدولة إشعار محلي عند انتقال رسالة SMS إلى failed
- [ ] تضمين رقم مستلم مخفياً ومعرّف الرسالة دون نص الرسالة الكامل
- [ ] إضافة بحث حسب رقم المستلم مع تطبيع آمن
- [ ] إضافة بحث حسب تاريخ الإرسال بنطاق من/إلى
- [ ] إضافة واجهة بحث متقدمة قابلة للفتح والإغلاق
- [ ] إضافة مسح البحث وإعادة ضبط نطاق التاريخ
- [ ] الحفاظ على مرشح حالات SMS الحالي وعدم خلط WhatsApp
- [ ] إضافة اختبارات منطق البحث ونطاق التاريخ
- [ ] إضافة اختبار لاستدعاء الإشعار عند فشل SMS مع mock حتمي
- [ ] تشغيل TypeScript والاختبارات والبناء
- [ ] حفظ checkpoint بعد مراجعة الفروقات


## تحسين سجلات SMS — سجل الإنجاز الأخير
- [x] إنشاء خدمة إشعار محلي مستقلة لفشل SMS
- [x] إنشاء قناة Android باسم «فشل رسائل SMS»
- [x] طلب صلاحية الإشعارات عند الحاجة فقط
- [x] إطلاق الإشعار بعد حفظ حالة SMS كـ failed دون تعطيل الطابور
- [x] إخفاء رقم المستلم وعدم تضمين نص الرسالة الكامل في الإشعار
- [x] إضافة بحث متقدم حسب رقم المستلم
- [x] دعم مطابقة الرقم المحلي 05 مع الصيغة الدولية +966
- [x] إضافة نطاق تاريخ من/إلى بصيغة YYYY-MM-DD شاملاً بداية ونهاية اليوم
- [x] إضافة فتح وإغلاق البحث ومسح الحقول
- [x] إبقاء البحث مقصوراً على سجلات SMS الصادرة
- [x] عزل حمولة الإشعار النقية عن Expo لاختبارها حتمياً
- [x] إضافة اختبارات البحث والإشعار
- [x] نجاح TypeScript و8 اختبارات SMS والبناء
- [ ] اختبار الإشعار على جهاز Android فعلي بعد منح الصلاحية
- [ ] حفظ checkpoint لهذه الجولة


## ربط إشعار فشل SMS بالتنقل
- [ ] إنشاء دالة نقية للتحقق من حمولة تفاعل إشعار SMS
- [ ] فتح `/sms-logs` عند الضغط على إشعار الفشل أثناء تشغيل التطبيق
- [ ] فتح `/sms-logs` عند تشغيل التطبيق من إشعار فشل SMS
- [ ] تجاهل الإشعارات غير الخاصة بفشل SMS بأمان
- [ ] منع تسجيل أو عرض نص الرسالة الكامل من بيانات الإشعار
- [ ] إضافة اختبار حتمي لتحليل حمولة الإشعار
- [ ] تشغيل TypeScript والاختبارات والبناء
- [ ] حفظ checkpoint بعد التحقق


## تنقل إشعار فشل SMS — سجل الإنجاز
- [x] إضافة وسم `sms-failure` لحمولة الإشعار
- [x] إنشاء محلل نقي يتحقق من المسار ومعرّف الرسالة
- [x] فتح `/sms-logs` عند التفاعل مع الإشعار أثناء تشغيل التطبيق
- [x] فتح `/sms-logs` عند تشغيل التطبيق من الإشعار
- [x] تجاهل الحمولة غير الموثوقة أو غير المتعلقة بـ SMS
- [x] عدم تمرير نص الرسالة الكامل عبر بيانات التنقل
- [x] إضافة اختبارات حتمية للتنقل والحمولة
- [x] نجاح TypeScript والبناء و10 اختبارات SMS
- [ ] اختبار التفاعل الفعلي على جهاز Android بعد إنشاء build
- [ ] حفظ checkpoint لهذه الجولة


## تحسين متابعة SMS — messageId وتفاصيل السجل
- [ ] تمرير `messageId` في بيانات تنقل إشعار فشل SMS
- [ ] قراءة `messageId` عبر Expo Router والتحقق منه
- [ ] تحديد السجل الفاشل تلقائياً عند فتح شاشة SMS
- [ ] تمرير معرف الرسالة إلى مسار `/sms-logs`
- [ ] إضافة عرض تفاصيل للسجل المحدد
- [ ] إضافة زر إعادة المحاولة داخل تفاصيل السجل الفاشل
- [ ] منع إعادة المحاولة للسجلات غير الفاشلة
- [ ] تحديث حالة التفاصيل بعد إعادة المحاولة
- [ ] إضافة اختبارات route params ومنطق اختيار السجل
- [ ] تشغيل TypeScript والاختبارات والبناء
- [ ] قراءة todo.md قبل checkpoint
- [ ] حفظ checkpoint بعد التحقق


## متابعة سجل SMS من الإشعار — سجل الإنجاز
- [x] تمرير `messageId` في route params عند الضغط على إشعار فشل SMS
- [x] التحقق من الحمولة قبل بناء مسار التنقل
- [x] تحديد السجل تلقائياً داخل `sms-logs`
- [x] تمييز السجل المحدد بصرياً
- [x] عرض تفاصيل المستلم والوقت والمحاولات والمحتوى وسبب الفشل
- [x] إضافة زر إعادة محاولة داخل تفاصيل السجل الفاشل
- [x] تعطيل الزر أثناء المعالجة ومنع ظهوره للحالات غير الفاشلة
- [x] تحديث القائمة بعد إعادة المحاولة
- [x] إضافة اختبارات التنقل والحمولة
- [x] نجاح TypeScript والبناء و10 اختبارات SMS
...
- [ ] جرد إجراءات tRPC ومسارات HTTP التي تستهلكها اللوحة
- [ ] جرد `adminApi` وطبقة طلبات لوحة التحكم وصيغ الاستجابات
- [ ] مطابقة أسماء الإجراءات والمدخلات والمخرجات والحقول الاختيارية
- [ ] مراجعة JWT وcookies وadminId والصلاحيات لكل إجراء إداري
- [ ] مراجعة CORS وproxy والنطاق الإنتاجي
- [ ] مراجعة أكواد HTTP وأخطاء tRPC وفك `result.data`
- [ ] مقارنة عقود Dashboard وUsers وSubscriptions وInvoices وAnalytics وSettings
- [ ] إصلاح الفجوات المؤكدة فقط
- [ ] إضافة اختبارات عقود API أو تحديث الاختبارات القائمة
- [ ] تشغيل TypeScript وlint والبناء والاختبارات في المشروعين
- [ ] توثيق النتيجة وقراءة todo.md قبل checkpoint
- [ ] حفظ checkpoint بعد اكتمال المراجعة


## مراجعة عقود API — نتائج التنفيذ
- [x] مقارنة appRouter وadminRouter مع adminApi البعيد
- [x] التحقق من إجراءات الإدارة الـ16 وأسماء المسارات
- [x] التحقق من صيغة tRPC للـ GET والـ POST
- [x] التحقق من API origin وSocket origin في لوحة التحكم
- [x] التحقق من JWT Authorization وadminId والدور
- [x] توثيق النتيجة في `API_CONTRACT_AUDIT.md`
- [x] عدم العثور على عدم تطابق حرج في عقد النجاح
- [x] توثيق فجوة تحويل أخطاء tRPC في `readResult`
- [x] توثيق الحاجة إلى تحقق إنتاجي لـ CORS وتسجيل الدخول
- [x] توثيق أن النسخة المحلية للوحة ليست checkout Git كاملاً وأن المصدر المعتمد هو المستودع البعيد
- [ ] إضافة محول أخطاء موحد إلى adminApi
- [ ] إضافة اختبارات contract للاستجابات الناجحة والفاشلة
- [ ] تنفيذ production smoke test
- [ ] حفظ checkpoint للمراجعة


## عطل تسجيل دخول لوحة التحكم — متابعة
- [ ] جمع سجل خطأ العميل دون حفظ كلمة المرور أو JWT
- [ ] مراجعة عنوان API الفعلي في build الإنتاجي
- [ ] التحقق من مسار admin login وصيغة body
- [ ] التحقق من CORS وOPTIONS للنطاق الإنتاجي
- [ ] التحقق من كود استجابة الخادم ورسالة الخطأ
- [ ] إعادة إنتاج الطلب محلياً وإنتاجياً بأمان
- [ ] إصلاح سبب العطل إن كان في العقد أو الإعدادات
- [ ] إضافة اختبار regression لتسجيل دخول الإدارة
- [ ] تشغيل TypeScript والبناء والاختبار
- [ ] حفظ checkpoint بعد الإصلاح


## اختبار لوحة التحكم محلياً بعد جلبها من GitHub
- [ ] جلب أحدث فرع من `alham-idea/messaging-gateway-admin`
- [ ] التحقق من commit وبنية الملفات والاعتماديات
- [ ] تثبيت الاعتماديات دون خلط npm وpnpm
- [ ] ضبط `VITE_API_URL` على الخادم المحلي
- [ ] تشغيل خادم Vite محلياً
- [ ] اختبار شاشة الدخول وصيغة admin login
- [ ] اختبار Dashboard وUsers وSubscriptions وInvoices وAnalytics وSettings
- [ ] فحص أخطاء المتصفح والشبكة
- [ ] تشغيل build وTypeScript وlint للوحة
- [ ] توثيق نتيجة الاختبار وأي فجوات


## اختبار لوحة التحكم المحلية — النتائج
- [x] جلب أحدث commit من `alham-idea/messaging-gateway-admin` على فرع main (`43adbe7`)
- [x] تثبيت الاعتماديات من `pnpm-lock.yaml` باستخدام `--ignore-scripts`
- [x] تشغيل لوحة التحكم محلياً على `http://127.0.0.1:4174`
- [x] تشغيلها مع `VITE_API_URL=http://127.0.0.1:3000`
- [x] اكتشاف فشل CORS المحلي عند الاختبار الأول (`Failed to fetch`)
- [x] إضافة origins التطوير localhost و127.0.0.1 إلى الخادم خارج production فقط
- [x] التحقق من OPTIONS وإرجاع `Access-Control-Allow-Origin` للمصدر المحلي
- [x] التحقق من وصول POST login محلياً عبر رفض آمن لبيانات وهمية (`تعذر التحقق من بيانات الدخول`)
- [x] نجاح `pnpm check` للوحة
- [x] نجاح `pnpm build` للوحة
- [ ] اختبار تسجيل دخول ناجح بحساب إداري صالح
- [ ] اختبار الصفحات بعد تسجيل الدخول
- [ ] معالجة تحذير Vite لحجم الحزمة
- [ ] حفظ checkpoint لتعديل CORS المحلي


## دفع لوحة التحكم إلى GitHub
- [ ] فحص حالة المستودع المستقل والفروقات المحلية
- [ ] التأكد من استبعاد الأسرار وملفات البناء المؤقتة
- [ ] تشغيل check وbuild قبل الدفع
- [ ] إنشاء commit واضح للتغييرات
- [ ] دفع commit إلى الفرع المعتمد في GitHub
- [ ] التحقق من commit البعيد وتوثيق النتيجة


## حساب إداري اختباري جديد
- [ ] تحديد طريقة الإنشاء الآمنة ومسار hashing المستخدم
- [ ] توليد بريد وكلمة مرور اختبارية مؤقتة
- [ ] إنشاء مدير نشط بدور admin دون لمس الحسابات الحالية
- [ ] التحقق من التسجيل محلياً عبر admin login
- [ ] حذف ملف كلمة المرور المؤقت من بيئة العمل بعد التحقق
- [ ] توثيق أن الحساب اختباري ويجب تغييره أو تعطيله بعد الاستخدام


## حساب إداري اختباري — النتيجة
- [x] التحقق من أن الحساب السابق موجود دون كشف كلمة مروره
- [x] إنشاء حساب إداري اختباري فريد بدور `admin`
- [x] الحساب نشط وقابل لتسجيل الدخول
- [x] التحقق المحلي من `POST /api/admin/login` وإرجاع HTTP 200
- [x] حذف سكربت الإنشاء المؤقت وملفات جلسة الاختبار
- [ ] تغيير كلمة المرور بعد أول دخول
- [ ] تعطيل الحساب أو حذفه بعد انتهاء الاختبار


## متغيرات بيئة لوحة التحكم
- [ ] قراءة أسماء متغيرات البيئة الفعلية من المستودع المستقل
- [ ] مطابقة VITE_API_URL مع نطاق الخادم المنشور
- [ ] مطابقة VITE_SOCKET_URL إن كان مستخدماً
- [ ] التحقق من عدم الحاجة إلى API key أو JWT ثابت في الواجهة
- [ ] توثيق قيم التطوير المحلي والإنتاج
- [ ] اختبار اتصال اللوحة بعد ضبط المتغيرات


## متغيرات بيئة لوحة التحكم — النتيجة
- [x] تحديد `VITE_API_URL`
- [x] تحديد `VITE_SOCKET_URL`
- [x] تحديد `VITE_SOCKET_PATH`
- [x] التحقق من أن لوحة التحكم لا تحتاج API key ثابتاً أو JWT مضمناً
- [x] مطابقة نطاق الخادم المنشور `https://msg-gateway-7lqw9uuq.manus.space`
- [x] توثيق قيم التطوير والإنتاج للمستخدم
- [ ] اختبار اتصال جديد بعد ضبط env في بيئة المستخدم


## تفعيل Socket.io للتحديثات اللحظية
- [ ] مراجعة إنشاء خادم Socket.io مع HTTP server
- [ ] مراجعة CORS وorigin وpath وcredentials
- [ ] مطابقة `VITE_SOCKET_URL` و`VITE_SOCKET_PATH` مع الخادم
- [ ] التحقق من مصادقة اتصال الإدارة وعدم قبول اتصال مجهول
- [ ] عزل أحداث SMS وWhatsApp وعدم بثها إلى القناة الخاطئة
- [ ] تفعيل بث تحديثات حالات الرسائل للوحة التحكم
- [ ] إضافة اختبارات اتصال وأحداث mock حتمية
- [ ] تحديث أدلة تكامل Socket.io ووثيقة الميزات
- [ ] تشغيل TypeScript والاختبارات والبناء
- [ ] حفظ checkpoint بعد التحقق


## تفعيل Socket.io — سجل الإنجاز
- [x] إضافة اعتماد `socket.io` للخادم
- [x] إرفاق Socket.io بخادم HTTP نفسه المستخدم في Express وtRPC
- [x] تثبيت path `/socket.io` وWebSocket مع polling fallback
- [x] ضبط CORS للنطاقات المسموحة وcredentials
- [x] رفض اتصال Socket غير الموثق أو المدير غير النشط عبر JWT handshake
- [x] دعم `admin:subscribe` وغرفة `admins` و`connection_status`
- [x] الحفاظ على فصل SMS وWhatsApp في عقد الأحداث
- [x] تحديث دليل Socket.io الإنجليزي والعربي
- [x] تحديث دليل ميزات العميل الإنجليزي والعربي
- [x] إضافة اختبارين حتميين لمسار Socket.io ورفض الاتصال المجهول
- [x] نجاح TypeScript والبناء واختبارات Socket.io
- [x] إعادة تشغيل خدمات المشروع؛ الخادم وTypeScript بحالة سليمة
- [ ] إضافة producers فعلية لبث تغييرات قاعدة البيانات إلى أحداث admin realtime
- [ ] اختبار اتصال لوحة التحكم الفعلي مع JWT صالح
- [ ] التحقق الإنتاجي بعد نشر الخادم
- [ ] قراءة todo.md قبل checkpoint
- [ ] حفظ checkpoint لتفعيل Socket.io
